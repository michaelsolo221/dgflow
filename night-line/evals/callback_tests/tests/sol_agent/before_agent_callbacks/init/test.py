"""Callback tests for before_agent_callback (init) — Sol."""
...
_spec = importlib.util.spec_from_file_location("sol_before_agent_init", str(_agents_dir / "python_code.py"))
...
def test_firestore_load_populates_state(mock_firestore_client):
    ...
    assert ctx.state["persona_id"] == "sol"
